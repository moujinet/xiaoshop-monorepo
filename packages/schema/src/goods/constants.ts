...
export const GOODS_EXPORT_RECORD_STATUSES = [
  { value: GoodsExportRecordStatus.PENDING, label: '等待导出', color: 'gray' },
  { value: GoodsExportRecordStatus.SUCCESS, label: '导出成功', color: 'green' },
  { value: GoodsExportRecordStatus.FAILED, label: '导出失败', color: 'red' },
]
