...
): IUseRequestReturn<IApiPaginationResult<IGoodsPageListItem>> {
 ...
 * @returns IUseRequestReturn<IApiPaginationResult<IGoodsPageListItem>>
 */
export function fetchGoodsRecyclePages(
  params?: Record<string, any>,
): IUseRequestReturn<IApiPaginationResult<IGoodsPageListItem>> {
  return useRequest<IApiPaginationResult<IGoodsPageListItem>>({
    method: 'get',
...
export function fetchGoodsSkuSpecs(id: IGoods['id']): IUseRequestReturn<IGoodsSku[]> {
  return useRequest<IGoodsSku[]>({
    method: 'get',
    url: '/goods/sku/specs',
    params: {
 ...
 * @param ids IGoods['id'][]
 * @param data Partial<IGoods>
 * @returns Promise<any>
 */
export function batchSetupGoods(ids: IGoods['id'][], data: Partial<IGoods>): Promise<any> {
  return usePromiseRequest({
    method: 'put',
 ...
 * @param data IGoodsBasic
 * @returns Promise<any>
 */
export function createGoods(data: IGoodsBasic): Promise<any> {
  return usePromiseRequest({
    method: 'post',
    url: '/goods/create',
    data,
 ...
 * @returns Promise<any>
 */
export function updateGoods(id: IGoods['id'], data: IGoodsBasic): Promise<any> {
  return usePromiseRequest({
    method: 'put',
    url: '/goods/update',
    data,
