...
import { LogisticFreightTemplateEntity } from '@/logistic/freight-template/entity'
...
import { GetFreightTemplatePagesRequest } from './dto/request'
import {
...
@Injectable()
export class LogisticFreightTemplateAdminService {
  constructor(
    @InjectRepository(LogisticFreightTemplateEntity)
    private readonly repository: Repository<LogisticFreightTemplateEntity>,
  ...
  async create(data: FreightTemplatePayload) {
    try {
      ...
      const template = new LogisticFreightTemplateEntity()
