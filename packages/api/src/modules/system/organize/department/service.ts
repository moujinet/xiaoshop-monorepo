...
import { SystemDepartment } from './entity'
import { SystemDepartmentPayload } from './dto'
...
export class SystemDepartmentService {
  constructor(
    @InjectRepository(SystemDepartment)
    private readonly repository: Repository<SystemDepartment>,
  ...
  async create(data: SystemDepartmentPayload) {
    try {
      ...
      const department = new SystemDepartment()
