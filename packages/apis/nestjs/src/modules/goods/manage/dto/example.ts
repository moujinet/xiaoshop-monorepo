...
export const example = {
  ...
  purchaseMaxQty: 0,
  purchaseMinQty: 1,
  stockDeductMode: GoodsInventoryDeductMode.ORDER,
  enableVipDiscount: Enabled.NO,
  enablePurchaseLimits: Enabled.NO,
  attributeTemplateId: 1,
  attributes: [
    {
      type: GoodsAttributeOptionType.RADIO,
      name: '产地',
      options: ['中国', '日本'],
      values: ['中国'],
    },
  ...
  freight: 0,
  freightTemplateId: 1,
  backFreightBy: GoodsReturnsFreightBy.BUYER,
  sort: 1,
  type: GoodsType.ENTITY,
  status: GoodsStatus.IN_STOCK,
  source: GoodsSource.MANUAL,
  publishMode: GoodsPublishMode.DIRECT,
  autoInStockAt: new Date(),
  buyBtnNameType: GoodsBuyBtnType.DEFAULT,
  buyBtnName: '',
  rating: {
    id: 1,
    overallGrade: GoodsRatingGrade.HIGH,
    overallGoodsScore: 5,
